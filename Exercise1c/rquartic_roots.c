...
{double b[3]={(4*a[0]*a[2]-a[1]*a[1]-a[0]*a[3]*a[3]),(a[1]*a[3]-4*a[0]),-a[2]};
    double root_inter1[4],r,quad_roots1[3],quad_roots2[3];
    ...
    double quad_coeff1[3],quad_coeff2[3],quad_coeff3[3],quad_coeff4[3];
    ...
    //Q2-(ii)
        ...
        quad_inter1=root[1];
        quad_inter2=root[2];
        printf("quad_inter=%lf %lf \n", quad_inter1,quad_inter2);
        ...
        quad_coeff1[3]={((r/2)+sqrt((r/2)*(r/2)-a[0])),((a[3]/2)+sqrt(((a[3]*a[3])/4)+r-a[2])),1};
        quad_coeff2[3]={((r/2)-sqrt((r/2)*(r/2)-a[0])),((a[3]/2)-sqrt(((a[3]*a[3])/4)+r-a[2])),1};
        quad_coeff3[3]={((r/2)+sqrt((r/2)*(r/2)-a[0])),((a[3]/2)-sqrt(((a[3]*a[3])/4)+r-a[2])),1};
        quad_coeff4[3]={((r/2)-sqrt((r/2)*(r/2)-a[0])),((a[3]/2)+sqrt(((a[3]*a[3])/4)+r-a[2])),1};
        ...
        printf("quad_case1=%d, quad_case2=%d\n",quad_case1, quad_case2);
        printf("ttt %lf %lf %lf %lf\n",quad_roots1[1],quad_roots1[2],quad_roots2[1],quad_roots2[2]);
